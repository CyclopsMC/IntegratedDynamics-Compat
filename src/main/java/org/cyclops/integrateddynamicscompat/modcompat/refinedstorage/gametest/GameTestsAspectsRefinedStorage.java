...
public class GameTestsAspectsRefinedStorage {
    ...
    private static final ResourceLocation RS_CREATIVE_CONTROLLER = ResourceLocation.fromNamespaceAndPath("refinedstorage", "creative_controller");
    private static final ResourceLocation RS_CREATIVE_STORAGE_BLOCK = ResourceLocation.fromNamespaceAndPath("refinedstorage", "creative_storage_block");
    private static final ResourceLocation RS_CREATIVE_FLUID_STORAGE_BLOCK = ResourceLocation.fromNamespaceAndPath("refinedstorage", "creative_fluid_storage_block");

    private static Block getRsBlock(ResourceLocation id) {
    ...
    private static Optional<Network> getNetworkAt(GameTestHelper helper, BlockPos pos) {
        return BlockEntityHelpers.getCapability(helper.getLevel(), helper.absolutePos(pos), RefinedStorageNeoForgeApi.INSTANCE.getNetworkNodeContainerProviderCapability())

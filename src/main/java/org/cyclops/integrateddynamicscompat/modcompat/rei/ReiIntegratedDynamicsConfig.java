...
public class ReiIntegratedDynamicsConfig implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(ReiDryingBasinCategory.ID, EntryStacks.of(RegistryEntries.BLOCK_DRYING_BASIN));
        registry.addWorkstations(ReiSqueezerCategory.ID, EntryStacks.of(RegistryEntries.BLOCK_SQUEEZER));
        registry.addWorkstations(ReiMechanicalDryingBasinCategory.ID, EntryStacks.of(RegistryEntries.BLOCK_MECHANICAL_DRYING_BASIN));
        registry.addWorkstations(ReiMechanicalSqueezerCategory.ID, EntryStacks.of(RegistryEntries.BLOCK_MECHANICAL_SQUEEZER));
    }

    @Override
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(RecipeDryingBasin.class, RegistryEntries.RECIPETYPE_DRYING_BASIN, ReiDryingBasinRecipe::new);
        registry.registerRecipeFiller(RecipeSqueezer.class, RegistryEntries.RECIPETYPE_SQUEEZER, ReiSqueezerRecipe::new);
        registry.registerRecipeFiller(RecipeMechanicalDryingBasin.class, RegistryEntries.RECIPETYPE_MECHANICAL_DRYING_BASIN, ReiMechanicalDryingBasinRecipe::new);
        registry.registerRecipeFiller(RecipeMechanicalSqueezer.class, RegistryEntries.RECIPETYPE_MECHANICAL_SQUEEZER, ReiMechanicalSqueezerRecipe::new);
    }
}
